/* =====================================================
Template Name   : Cablehub
Description     : Internet, Cable TV And Broadband Provider HTML5 Template
Author          : Themesland
Version         : 1.2
=======================================================*/
...
(function ($) {
    ...
    $(document).ready(function () {
        try {
            ...
            $('.navbar-nav .nav-link').each(function () {
                ...
                var hrefPath = href.split('/').pop().split('#')[0];
    ...
    // cart quantity handlers removed (shop/cart functionality removed)
